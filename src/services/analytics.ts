...
export function trackEvent(name: AnalyticsEventName, payload?: Record<string, string | number | boolean>): AnalyticsEvent {
  const event: AnalyticsEvent = { id: crypto.randomUUID(), name, payload, at: new Date().toISOString() };
